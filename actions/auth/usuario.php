...
class usuario
{
    ...
    public function __construct($id_user, $rol = 2, $cedula, $nombre, $apellido, $nacimiento, $correo, $telefono, $passwordHash, $foto = null, $estado = 2, $token = null, $fechaDeRegistro = null) 
    {
